...
@Component({
  selector: 'app-show-electronic-products',
  templateUrl: './show-electronic-products.component.html',
  styleUrls: ['./show-electronic-products.component.scss']
})
export class ShowElectronicProductsComponent implements OnInit {
