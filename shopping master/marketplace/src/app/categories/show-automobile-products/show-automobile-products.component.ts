...
@Component({
  selector: 'app-show-automobile-products',
  templateUrl: './show-automobile-products.component.html',
  styleUrls: ['./show-automobile-products.component.scss']
})
export class ShowAutomobileProductsComponent implements OnInit {
