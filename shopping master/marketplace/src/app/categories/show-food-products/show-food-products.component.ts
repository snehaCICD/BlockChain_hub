...
@Component({
  selector: 'app-show-food-products',
  templateUrl: './show-food-products.component.html',
  styleUrls: ['./show-food-products.component.scss']
})
export class ShowFoodProductsComponent implements OnInit {
  product : Product[] =[
